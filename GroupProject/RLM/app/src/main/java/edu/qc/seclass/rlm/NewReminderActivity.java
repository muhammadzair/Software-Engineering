...
//                    repeatTextField.setText("Repeats Every " + repeatType);
    ...
    public void addReminder (View v) {
        ...
        if (!repeatTextField.getText().toString().isEmpty()){
            repeatText = Integer.parseInt(repeatTextField.getText().toString());
        }
        if (!priorityTextField.getText().toString().isEmpty()){
            priorityNum = Integer.parseInt(priorityTextField.getText().toString());
        }
